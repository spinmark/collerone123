    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      <div className="bg-white rounded-lg shadow-xl w-[90%] sm:w-[400px] p-6">
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-[24px] font-semibold text-gray-800">Sign Up</h2>
          <button className="text-gray-500 hover:text-gray-800 text-[30px]" onClick={() => props.setOpenSignup(false)}>&times;</button>
        </div>
